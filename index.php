        ...
        <div class="darkhearderwrap">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-1" style="position: absolute; top: 0; left: 0;">
                    <!-- Image placed on the left side -->
                    <img src="assets/img/bulb.jpg" width="550" height="750" alt="">
                    </div>
                    <div class="col-lg-6 signup">
                        <h1>Electricity Billing System</h1>
                        <p>Step into a world where managing your electricity bills is as effortless as flicking a switch. Say goodbye to the paperwork hassle and hello to a brilliantly illuminated billing experience.</p>
                    </div>
